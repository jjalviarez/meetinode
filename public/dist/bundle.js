...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! sweetalert2 */ \"./node_modules/sweetalert2/dist/sweetalert2.all.js\");\n/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_1__);\n\n\nwindow.addEventListener('DOMContentLoaded', function () {\n  var comentarios = document.querySelectorAll('.eliminar-comentario');\n\n  if (comentarios.length) {\n    comentarios.forEach(function (comentario) {\n      comentario.addEventListener('click', function (e) {\n        e.preventDefault();\n        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire({\n          title: 'Quieres Eliminar le comentario',\n          text: \"You won't be able to revert this!\",\n          icon: 'warning',\n          showCancelButton: true,\n          confirmButtonColor: '#3085d6',\n          cancelButtonColor: '#d33',\n          confirmButtonText: 'Yes, delete it!'\n        }).then(function (result) {\n          if (result.value) {\n            axios__WEBPACK_IMPORTED_MODULE_0___default.a[\"delete\"](comentario.href).then(function (respuesta) {\n              //console.log(respuesta);\n              if (respuesta.status == 200) {\n                comentario.parentElement.parentElement.remove();\n                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire('Deleted!', respuesta.data.mensaje, 'success');\n              }\n            })[\"catch\"](function (error) {\n              sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire('Cancelled', error.response.data.mensaje, 'error');\n            });\n          }\n        });\n      });\n    });\n  }\n});\n\n//# sourceURL=webpack:///./public/js/comentarios.js?");
